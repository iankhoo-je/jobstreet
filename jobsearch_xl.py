...
class App:
    ...
    def __init__(self, parent):
        ...
        self.drop = OptionMenu(self.parent, self.menu, '1','2','3','4','5','6','7')
        self.drop.pack()
...
def general():
    ...
    xlsx_file_path = f'C:/Users/Ian/Desktop/jobsearch/{job_keyword}_{location_keyword}.xlsx'
    ...
    for idx, link in enumerate(a_tag_lst):
        ...
        if post_counter == 1:
            ...
            data['Job Posted'].append('No post shown')
    ...
    worksheet.write(0,0,f'Accessed Jobstreet search query at {date_today}', italic_font)
